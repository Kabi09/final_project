...
exports.createReview = catchAsyncError(async (req, res, next) => {
    ...
    // Step 1: Check if the user has purchased this product with a valid unique code
    ...
    if (!order) {
        return res.status(403).json({
            success: false,
            message: 'You can only review a product you have purchased with a valid unique code.'
        });
    }
